...
\definecolor{definered}{HTML}{FDECEC}
\definecolor{defineborder}{HTML}{D98282}
...
\tcolorboxenvironment{define}{enhanced,breakable,colback=definered,colframe=defineborder,boxrule=0.5pt,arc=1mm,left=2mm,right=2mm,top=1mm,bottom=1mm,before skip=0.8em,after skip=0.8em}
...
%\subsection*{Example: Determinant and sign}
%
